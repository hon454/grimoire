...
| Icon | Plugin | 설명 |
| --- | :---: | --- |
| <img src="plugins/grimoire/assets/icon.png" width="72" alt="Grimoire icon"> | [**Grimoire**](plugins/grimoire/) | Grimoire bootstrap, skill authoring, ChatGPT 열기, handoff prompt 생성, 검증된 side-conversation handoff, current-work triage, issue preflight, readiness review와 Linear closeout, locale-grounded translation, SHA-pinned GitHub PR review, review response, Git cleanup, conflict resolution을 위한 workflow skill과 hook입니다. |
...
- `plugins/grimoire/skills/open-chatgpt-in-app-browser/SKILL.md`: Codex 인앱 브라우저에서 ChatGPT를 여는 명시적 호출 skill입니다.
...
- `plugins/grimoire/skills/gh-pr-review-loop/SKILL.md`: 하나의 SHA-pinned snapshot을 정적으로 검토하고 `gh`를 통해 deduplicated inline finding과 최종 review 하나를 게시하는 명시적 호출 GitHub PR review loop입니다.
