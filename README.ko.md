...
| <img src="plugins/book-of-engineering/assets/icon.png" width="72" alt="Book of Engineering icon"> | [**Book&nbsp;of&nbsp;Engineering**](plugins/book-of-engineering/) | 현재 작업 맥락을 이해하고 다음 행동을 고르며, 구현 전 issue 유효성을 감사하는 engineering workflow입니다. |
...
- `plugins/book-of-engineering/skills/issue-preflight/SKILL.md`: tracker를 변경하지 않고 구현 전 issue validity verdict를 초안화하는 명시적 호출 skill입니다.
- Book of Engineering `0.3.0`은 구현 전 issue, PR, branch-scoped work의 유효성을 확인하는 `$issue-preflight`를 추가합니다.
