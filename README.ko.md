...
- `plugins/grimoire/skills/gh-pr-review-loop/SKILL.md`: 하나의 SHA-pinned snapshot을 정적으로 검토하고 `gh`를 통해 inline finding과 최종 review 하나를 게시하는 명시적 호출 GitHub PR review loop입니다.
